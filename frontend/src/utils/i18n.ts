...
export const translations = {
  zh: {
    ...
    'profile.englishBackup': '英文简介备份',
    'profile.englishRequired': '请填写完整且不含中文的英文简介备份',
    'blog.general': '默认分类',
    'blog.loading': '正在加载文章...',
    'blog.empty': '还没有文章。',
    ...
    'article.englishRequired': '请填写完整且不含中文的英文版本',
    'wechat.title': '微信联系',
    'wechat.empty': '暂无二维码',
  ...
  en: {
    ...
    'profile.englishBackup': 'English profile backup',
    'profile.englishRequired': 'Complete the English profile backup without Chinese text.',
    ...
    'article.englishRequired': 'Complete the English version without Chinese text.',
